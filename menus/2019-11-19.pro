...
#-list:
  #-item{Seared pork chops with apples and onions (#title{Fast}, page 750)}
  #-item{Squash and parsnip gratin}
  #-item{Pan-fried potatoes}
  #-item{Blaukraut}
#:
...
#-list:
  #-item{Homemade chicken ramen (#title{Fast}, page 238)}
  #-item{Hijiki salad}
  #-item{Pickles}
  #-item{Leftover squash gratin}
  #-item{Huckleberry jello: lemon jello with some of the water left out and creme fraiche added with frozen huckleberries in it.}
#:
...
Ate with onion pan bread (Bittman again, but not the #title{Fast} one). I love this recipe so much; the onions are so sweet and jammy and baked right into the bread. I usually substitute a bit of rye flour in for some of the white (about 1/2 cup). I keep thinking I should try making this with some fresh thyme in the onions but I never do because they taste so great without it. But next time perhaps.
