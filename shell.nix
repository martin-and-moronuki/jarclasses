let
    ...
    hsPackageSelection = haskellPackages: with haskellPackages; [
        aeson aeson-optics aeson-pretty async blaze-html bytestring fsnotify http-conduit lens ormolu path prosidy relude safe-exceptions stm text unordered-containers wai warp
    ];
