...
data Block = BlockMain Main | BlockParagraph Paragraph | BlockComment Comment | BlockH H
    | BlockOrderedList OrderedList | BlockBulletedList BulletedList | BlockQuote Quote
